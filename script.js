...
const ruun = new Runing([1, 3], 345, 56, 78);
...
class App {
  ...
  constructor() {
    ...
    inputType.addEventListener('change', this._toggleNewElevn);
  ...
  _showForm(mapE) {
    this.#mapEvent = mapE;
    // console.log(this.#mapEvent); // This is to confirm Map Position Object
    form.classList.remove('hidden');
    inputDistance.focus();
  }

  _toggleNewElevn() {
    // Toggle Over Cadence and Elevation
